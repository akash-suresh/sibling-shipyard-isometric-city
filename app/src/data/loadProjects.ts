...
import { buildingArchetypes, projectStages, projectStatuses, type ProjectDefinition } from "./types"
...
export function validateProjects(value: unknown): ProjectDefinition[] {
  ...
  return value.map((entry, index) => {
    ...
    if (!isRecord(entry.building) || typeof entry.building.archetype !== "string" || typeof entry.building.accent !== "string") {
